...
<div class="outer">
    ...
    <div class="middle">
        <div id="ui" class="inner">
            ...
            $opt = $_GET['Sort'];
            $sql = "select * from selling where uname= '$uname'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<p id='rbg'>Price : ".$row["price"]."</p><p id='lcl'>Condition : ".$row[icond]."</p><form method='post' action='deleteprocess.php'>";
                    echo "<input type='hidden' name='id' value='$row[id] '>";
                    echo "<input type='submit' class='btn btn-outline-dark' value='Delete Item'></form>";
